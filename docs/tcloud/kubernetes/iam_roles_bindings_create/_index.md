---
linkTitle: "tcloud kubernetes iam roles bindings create"
...
cascade:
  type: docs
---
## tcloud kubernetes iam roles bindings create

Create a binding to a user, team, or service account

```
tcloud kubernetes iam roles bindings create <role> [flags]
```
